public class Driver{
	...
	int[]ary7 = { 3, 5, 1, 6, 9};
	int[]ary8 = {10, 2, 6, 1, 7, -5};
	int[]ary9 = {0, 4, 3, 6, 4, 0};
	int[]ary10 = {10, 3, 6, 2, 9, 10};
	int[]ary11 = {-2, 4, 2, 6, 3, 7, -2};

	Sorts.printArray(ary7);
        Sorts.selectionSort(ary7);
	Sorts.printArray(ary7);

	Sorts.printArray(ary8);
        Sorts.selectionSort(ary8);
	Sorts.printArray(ary8);

	Sorts.printArray(ary9);
        Sorts.selectionSort(ary9);
	Sorts.printArray(ary9);

	Sorts.printArray(ary10);
        Sorts.mergesort(ary10);
	Sorts.printArray(ary10);

	Sorts.printArray(ary11);
        Sorts.mergesort(ary11);
	Sorts.printArray(ary11);
    }
}
